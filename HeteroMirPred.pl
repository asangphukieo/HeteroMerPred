...
foreach $line (@file_data)
     {
	  ...
	  #$foldfile=">>$num.fold";	                   
		...
		#system("rm *.ps");
		#change file name of secondary structure pic 
...
system("java -classpath \$CLASSPATH:weka.jar:libsvm.jar -Xmx10000m -Xss5000m weka.classifiers.meta.Vote -l Vote.model -T $filename.csv -p 0 > out1.txt");
...
system("python read_output_to_file.py $filename");
